  ...
  return (
    <section className="container relative mt-14">
      ...
      <div className="overflow-hidden relative">
        ...
        <button
          className="absolute top-1/2 left-2 sm:left-4 transform -translate-y-1/2 bg-[#dce3e6] text-[#2e3133] text-sm sm:text-lg p-2 rounded-full z-10"
          onClick={handlePrev}
        >
          <IoIosArrowBack />
        </button>
        <button
          className="absolute top-1/2 right-2 sm:right-4 transform -translate-y-1/2 bg-[#dce3e6] text-[#2e3133] text-sm sm:text-lg p-2 rounded-full z-10"
          onClick={handleNext}
        >
          <IoIosArrowForward />
        </button>
