...
export default function SubscribeBox() {
  return (
    <section className=" mb-[6rem] mt-24  flex items-center px-7 container rounded-[1rem] bg-[#26658c] text-white overflow-hidden h-[135px]">
      <svg
        id="Layer_1"
        data-name="Layer 1"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 350 342.38"
        className="text-[#4abfd9] w-[250px] -rotate-12 fill-current px-8"
      >
        <defs>
          <style>
      ...
      <div className="flex items-center">
        <input
          ...
          className="text-black w-[400px] h-12 p-3 rounded-l-[1rem] border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <button className="h-12 py-3 px-5 bg-[#4abfd9] text-white rounded-r-[1rem] font-semibold">
          Sign Up
        </button>
      </div>
    </section>
