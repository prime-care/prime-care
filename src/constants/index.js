...
export const slider = [
    { src: "images/slide-1.jpg", alt: "Slide 1", text: "On All Baby <br/> Lotions" },
    { src: "images/slide-2.jpg", alt: "Slide 2", text: "Support <br/> Your Health <br/> With Nutrition" },
    { src: "images/slide-3.jpg", alt: "Slide 3", text: "Natural <br/> Cosmetics" }
];
